...
unlocked to sign the Huntcoin-Qt.app bundle.
...
allowing somebody to distribute a Huntcoin-Qt.app or huntcoin-qt-setup.exe with a valid
...
that the huntcoin-qt.exe file inside the installer had not been tampered with.
