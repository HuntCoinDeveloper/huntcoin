...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<HuntcoinAmountField*>("payAmount")->setValue(amount);
...
void TestGUI()
{
    ...
    QString balanceComparison = HuntcoinUnits::formatWithUnit(unit, balance, false, HuntcoinUnits::separatorAlways);
    ...
    // Amount input
    HuntcoinAmountField* amountInput = receiveCoinsDialog.findChild<HuntcoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: huntcoin:")) != -1);
