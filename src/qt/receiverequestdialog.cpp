...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatHuntcoinURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + HuntcoinUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatHuntcoinURI(info));
}
