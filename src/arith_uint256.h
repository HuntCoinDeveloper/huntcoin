...
#ifndef HUNTCOIN_ARITH_UINT256_H
#define HUNTCOIN_ARITH_UINT256_H
...
public:
     ...
     *
     * Huntcoin only uses this "compact" format for encoding difficulty
...
#endif // HUNTCOIN_ARITH_UINT256_H
