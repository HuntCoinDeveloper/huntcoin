...
#ifndef HUNTCOIN_TEST_SCRIPTNUM10_H
#define HUNTCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Huntcoin Core 0.10.0, for cross-comparison.
 */
public:
