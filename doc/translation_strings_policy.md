...
This document provides guidelines for internationalization of the Huntcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `huntcoin_en.ts` remains unchanged.
