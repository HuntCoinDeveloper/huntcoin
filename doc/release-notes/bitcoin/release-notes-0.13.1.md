...
- **Signature covers value:** A simple improvement in the way signatures are
  ...
  of huntcoins they think they are spending, and by having full nodes refuse to
  accept those signatures unless the amount of huntcoins being spent is exactly
...
- **Increased security for multisig:** Bitcoin addresses (both P2PKH addresses
  ...
  believed to be provided by Huntcoin's choice of parameters for its Elliptic
...
- **More efficient almost-full-node security** Satoshi Nakamoto's original
  ...
  produce an accurate copy of Huntcoin's current ledger (called the UTXO set),
...
[Segwit FAQ]: https://huntcoincore.org/en/2016/01/26/segwit-benefits/
[segwit wallet developers guide]: https://huntcoincore.org/en/segwit_wallet_dev/
[BIP141]: https://github.com/huntcoin/bips/blob/master/bip-0141.mediawiki
[BIP143]: https://github.com/huntcoin/bips/blob/master/bip-0143.mediawiki
[BIP144]: https://github.com/huntcoin/bips/blob/master/bip-0144.mediawiki
[BIP145]: https://github.com/huntcoin/bips/blob/master/bip-0145.mediawiki
[versionbits FAQ]: https://huntcoincore.org/en/2016/06/08/version-bits-miners-faq/
...
[BIP147]: https://github.com/huntcoin/bips/blob/master/bip-0147.mediawiki
...
- #8848 `7a34a46` Add NULLDUMMY verify flag in huntcoinconsensus.h (jl2012)
...
- #8940 `5b4192b` Add x9 service bit support to dnsseed.bluematt.me, seed.huntcoinstats.com (TheBlueMatt, cdecker)
- #8944 `685e4c7` Remove bogus assert on number of oubound connections. (TheBlueMatt)
- #8949 `0dbc48a` Be more agressive in getting connections to peers with relevant services (gmaxwell)

### Build system
- #8293 `fa5b249` Allow building libhuntcoinconsensus without any univalue (luke-jr)
- #8492 `8b0bdd3` Allow building bench_huntcoin by itself (luke-jr)
...
- #8829 `2a8bca4` Add huntcoin-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` huntcoin-util-test.py should fail if the output file is empty (jnewbery)
...
- #8860 `0bee740` util: Move wait_huntcoinds() into stop_nodes() (MarcoFalke)
...
- #8683 `8a7d7ff` Fix incorrect file name huntcoin.qrc  (huntcoinsSG)
...
- #8817 `bcf3806` update huntcoin-tx to output witness data (jnewbery)
