Huntcoin Core version 0.14.2 is now available from:

  <https://huntcoin.org/bin/huntcoin-core-0.14.2/>
...
(in Huntcoin Core 0.10.3) it has been disabled by default.
...
Since 0.14.0 the approximate transaction fee shown in Huntcoin-Qt when using coin
...
- #10228 `ae479bc` Regenerate huntcoin-config.h as necessary (theuni)
