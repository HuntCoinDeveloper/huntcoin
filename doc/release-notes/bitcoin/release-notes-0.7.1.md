...
source-only tarballs/zipballs directly from there:
  https://github.com/huntcoin/huntcoin/tarball/v0.7.1  # .tar.gz
  https://github.com/huntcoin/huntcoin/zipball/v0.7.1  # .zip
...
* Clicking on a huntcoin: URI on Windows should now launch Huntcoin-Qt properly.
