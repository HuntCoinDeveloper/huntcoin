...
We recommend that everybody running prior versions of huntcoind/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/huntcoin/huntcoin/tarball/v0.7.0  # .tar.gz
  https://github.com/huntcoin/huntcoin/zipball/v0.7.0  # .zip
...
in your terminal, then install the huntcoin-qt package:
  sudo apt-get install huntcoin-qt
...
Core huntcoin handling and blockchain database
...
* Ensure a changed huntcoin unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for huntcoin-qt.exe
* (Windows only): add meta-data to huntcoin-qt.exe (e.g. description)
...
* Bash programmable completion for huntcoind(1)
