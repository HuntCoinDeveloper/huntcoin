Huntcoin Core version 0.13.2 is now available from:

  <https://huntcoin.org/bin/huntcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update huntcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow huntcoin-tx to create v2 transactions (btcdrak)
