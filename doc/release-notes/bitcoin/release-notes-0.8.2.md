...
MacOSX:
* OSX support for click-to-pay (huntcoin:) links
...
* Entering the 'getblocktemplate' or 'getwork' RPC commands into the Huntcoin-Qt debug
console will cause Huntcoin-Qt to crash. Run Huntcoin-Qt with the -server command-line
