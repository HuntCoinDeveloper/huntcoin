Huntcoin Core version 0.14.1 is now available from:

  <https://huntcoin.org/bin/huntcoin-core-0.14.1/>
...
here:
[reducing-huntcoind-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
...
- #10130 `ecc5232` huntcoin-tx input verification (awemany, jnewbery)
