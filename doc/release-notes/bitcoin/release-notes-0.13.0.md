...
- Adding `dbcache=100` in huntcoin.conf
...
huntcoin-cli: arguments privacy
------------------------------
...
For example:
    ...
    $ src/huntcoin-cli -stdin walletpassphrase
    mysecretcode
    120
...
- `huntcoin-${VERSION}-arm-linux-gnueabihf.tar.gz`: Linux binaries targeting
  the 32-bit ARMv7-A architecture.
- `huntcoin-${VERSION}-aarch64-linux-gnu.tar.gz`: Linux binaries targeting
...
compatible peers.
[BIP 152](https://github.com/huntcoin/bips/blob/master/bip-0152.mediawiki)
...
141](https://github.com/huntcoin/bips/blob/master/bip-0141.mediawiki), [BIP
143](https://github.com/huntcoin/bips/blob/master/bip-0143.mediawiki), [BIP
144](https://github.com/huntcoin/bips/blob/master/bip-0144.mediawiki), and [BIP
145](https://github.com/huntcoin/bips/blob/master/bip-0145.mediawiki) are
...
Witness)] (https://github.com/huntcoin/bips/blob/master/bip-0141.mediawiki).
...
(https://github.com/huntcoin/bips/blob/master/bip-0141.mediawiki) for additional
details.)
...
The two phases are distinct in the Huntcoin-Qt GUI. During the first one,
...
- The optional new p2p message "feefilter" is implemented and the protocol
  ...
  feerate. [BIP 133](https://github.com/huntcoin/bips/blob/master/bip-0133.mediawiki)
...
65](https://github.com/huntcoin/bips/blob/master/bip-0065.mediawiki)

  - OP_NOP3 has been renamed to OP_CHECKSEQUENCEVERIFY by [BIP 
112](https://github.com/huntcoin/bips/blob/master/bip-0112.mediawiki)
...
- Each ZMQ notification now contains an up-counting sequence number that allows
  ...
  PR [#7762](https://github.com/huntcoin/huntcoin/pull/7762).
...
- #7550 `8b958ab` Input-from-stdin mode for huntcoin-cli (laanwj)
...
- #7613 `3798e5d` Add autocomplete to huntcoin-qt's console window (GamerSg)
...
- #7636 `fb0ac48` Add huntcoin address label to request payment QR code (makevoid)
- #8231 `760a6c7` Fix a bug where the SplashScreen will not be hidden during startup (jonasschnelli)
- #8256 `af2421c` BUG: huntcoin-qt crash (fsb4000)
- #8257 `ff03c50` Do not ask a UI question from huntcoind (sipa)
- #8288 `91abb77` Network-specific example address (laanwj)
- #7707 `a914968` UI support for abandoned transactions (jonasschnelli)
- #8207 `f7a403b` Add a link to the Huntcoin-Core repository and website to the About Dialog (MarcoFalke)
...
- #8047 `37f9a1f` Test_framework: Set wait-timeout for huntcoind procs (MarcoFalke)
...
- #8164 `0f24eaf` [Huntcoin-Tx] fix missing test fixtures, fix 32bit atoi issue (jonasschnelli)
...
- #7744 `d8e862a` test_framework: detect failure of huntcoind startup (laanwj)
...
- #7975 `fc23fee` Update huntcoin-core GitHub links (MarcoFalke)
