Huntcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/huntcoin/files/Huntcoin/huntcoin-0.5.4/
...
http://gitorious.org/huntcoin/huntcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Huntcoin-Qt notifications under Growl 1.3.
Increase required age of Huntcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxHuntcoin properly when installing Huntcoin-Qt over it. (Windows)
