Huntcoin Core version 0.10.4 is now available from:

  <https://huntcoin.org/bin/huntcoin-core-0.10.4/>
...
- #6953 `43c2789` Split huntcoin-tx into its own package
- #6953 `dfe0d4d` Include huntcoin-tx binary on Debian/Ubuntu
