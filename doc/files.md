...
* huntcoin.conf: contains configuration settings for huntcoind or huntcoin-qt
* huntcoind.pid: stores the process id of huntcoind while running
...
* debug.log: contains debug information and general logging generated by huntcoind or huntcoin-qt
